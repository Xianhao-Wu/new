...
parser.add_argument('--input_dir', default='/root/autodl-tmp/dataste/input', type=str, help='Directory of validation images')
parser.add_argument('--output_dir', default='./output', type=str, help='Directory of validation images')
parser.add_argument('--weights', default='/root/autodl-tmp/code/checkpoints/Deraininig/models/Multiscale/model_latest.pth', type=str, help='Path to weights') 
